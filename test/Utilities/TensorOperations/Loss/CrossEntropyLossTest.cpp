...
TEST(CrossEntropyLoss, ComputesCorrectAnswer_categoricalOneHotLabels_halfPrecision) {
    srand(time(NULL));
...
TEST(CrossEntropyLoss, ComputesCorrectAnswer_classIndexLabels_halfPrecision) {
    srand(time(NULL));
