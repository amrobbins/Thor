...
TEST(CublasMatrixMultiply, OperationTypeTableIncludesExpandedFloatAndFp8Combinations) {
    ...
    EXPECT_FALSE(
        isSupportedCublasLtOperationType(CUBLAS_COMPUTE_32F_FAST_16F, CUDA_R_32F, CUDA_R_8F_E4M3, CUDA_R_8F_E4M3, CUDA_R_16F, CUDA_R_16F));
    EXPECT_FALSE(
        isSupportedCublasLtOperationType(CUBLAS_COMPUTE_32F_FAST_16BF, CUDA_R_32F, CUDA_R_8F_E4M3, CUDA_R_8F_E5M2, CUDA_R_16BF, CUDA_R_16BF));
    EXPECT_FALSE(
        isSupportedCublasLtOperationType(CUBLAS_COMPUTE_32F_FAST_TF32, CUDA_R_32F, CUDA_R_8F_E4M3, CUDA_R_8F_E4M3, CUDA_R_16F, CUDA_R_16F));
