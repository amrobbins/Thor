...
//     CategoricalAccuracy::LabelType labelType = rand() % 2 ? CategoricalAccuracy::LabelType::INDEX :
//     CategoricalAccuracy::LabelType::ONE_HOT; uint32_t numClasses = 1 + (rand() % 20);
//     FIXME what should be the input datatypes and dimensions
//     if (labelType == CategoricalAccuracy::LabelType::INDEX)
//         categoricalAccuracy = builder.receivesClassIndexLabels(numClasses).build();
//     else
//         categoricalAccuracy = builder.receivesOneHotLabels().build();
//
...
//
//     CategoricalAccuracy::LabelType jsonLabelType = j.at("label_type").get<CategoricalAccuracy::LabelType>();
