...
TEST(Activations, TanhSerializeDeserialize) {
    ...
    shared_ptr<ThorImplementation::CustomLayer> stampedTanh = dynamic_pointer_cast<ThorImplementation::CustomLayer>(newStamp.getTrainableLayer(0));
    ASSERT_NE(stampedTanh, nullptr);
    ASSERT_EQ(stampedTanh->getLayerType(), "CustomLayer<Tanh>");
...
TEST(Activations, TanhRegistered) {
    ...
    shared_ptr<ThorImplementation::CustomLayer> stampedTanh = dynamic_pointer_cast<ThorImplementation::CustomLayer>(stampedNetwork.getTrainableLayer(0));
    ASSERT_NE(stampedTanh, nullptr);
    ASSERT_EQ(stampedTanh->getLayerType(), "CustomLayer<Tanh>");
