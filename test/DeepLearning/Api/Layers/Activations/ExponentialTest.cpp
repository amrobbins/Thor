...
TEST(Activations, ExponentialSerializeDeserialize) {
    ...
    shared_ptr<ThorImplementation::CustomLayer> stampedExponential = dynamic_pointer_cast<ThorImplementation::CustomLayer>(newStamp.getTrainableLayer(0));
    ASSERT_NE(stampedExponential, nullptr);
    ASSERT_EQ(stampedExponential->getLayerType(), "CustomLayer<Exponential>");
...
TEST(Activations, ExponentialRegistered) {
    ...
    shared_ptr<ThorImplementation::CustomLayer> stampedExponential = dynamic_pointer_cast<ThorImplementation::CustomLayer>(stampedNetwork.getTrainableLayer(0));
    ASSERT_NE(stampedExponential, nullptr);
    ASSERT_EQ(stampedExponential->getLayerType(), "CustomLayer<Exponential>");
