...
TEST(Activations, EluSerializeDeserialize) {
    ...
    shared_ptr<ThorImplementation::CustomLayer> stampedElu = dynamic_pointer_cast<ThorImplementation::CustomLayer>(newStamp.getTrainableLayer(0));
    ASSERT_NE(stampedElu, nullptr);
    ASSERT_EQ(stampedElu->getLayerType(), "CustomLayer<Elu>");
...
TEST(Activations, EluRegistered) {
    ...
    shared_ptr<ThorImplementation::CustomLayer> stampedElu = dynamic_pointer_cast<ThorImplementation::CustomLayer>(stampedNetwork.getTrainableLayer(0));
    ASSERT_NE(stampedElu, nullptr);
    ASSERT_EQ(stampedElu->getLayerType(), "CustomLayer<Elu>");
