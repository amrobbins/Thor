...
//
//         std::optional<Tensor> actualLabels = meanAbsolutePercentageError.getLabels();
...
//
//         std::optional<Tensor> actualPredictions = meanAbsolutePercentageError.getPredictions();
...
//
//         std::optional<Tensor> actualLoss = meanAbsolutePercentageError.getLoss();
...
//     ASSERT_EQ(meanAbsolutePercentageErrorJ.at("loss_shape").get<Loss::LossShape>(), Loss::LossShape::RAW);
//     ASSERT_EQ(meanAbsolutePercentageErrorJ.at("loss_data_type").get<DataType>(), lossDataType);
//
...
//     Layer::deserialize(archiveReader, meanAbsolutePercentageErrorJ, &newNetwork);
//     if (lossShaper)
...
//     }
//
//     ASSERT_EQ(stampedMeanAbsolutePercentageError->getPredictionsInput().value(), stampedFC->getFeatureOutputs()[0].value());
//     ASSERT_EQ(stampedMeanAbsolutePercentageError->getLabelsInput().value(), stampedLabelsInput->getFeatureOutput().value());
//     if (stampedLossShaper) {
//         ASSERT_EQ(stampedMeanAbsolutePercentageError->getLossOutput().value(), stampedLossShaper->getFeatureInput().value());
//         ASSERT_EQ(stampedLossShaper->getFeatureOutput().value(), stampedLossOutput->getFeatureInput().value());
//     } else if (stampedReshape) {
//         ASSERT_EQ(stampedMeanAbsolutePercentageError->getLossOutput().value(), stampedReshape->getFeatureInput().value());
//         ASSERT_EQ(stampedReshape->getFeatureOutput().value(), stampedLossOutput->getFeatureInput().value());
//     } else {
//         ASSERT_EQ(stampedMeanAbsolutePercentageError->getLossOutput().value(), stampedLossOutput->getFeatureInput().value());
//     }
//
