...
//
//         if (setLossDataType) {
//             lossDataType = rand() % 2 ? DataType::FP32 : DataType::FP16;
...
//
//         std::optional<Tensor> actualLabels = meanSquaredError.getLabels();
...
//
//         std::optional<Tensor> actualPredictions = meanSquaredError.getPredictions();
...
//
//         std::optional<Tensor> actualLoss = meanSquaredError.getLoss();
//         ASSERT_TRUE(actualLoss.has_value());
//         ASSERT_EQ(actualLoss.value().getDataType(), setLossDataType ? lossDataType : predictionsDataType);
//         if (shape == 0) {
...
//         ASSERT_EQ(cloneLoss.value().getDataType(), setLossDataType ? lossDataType : predictionsDataType);
//         if (shape == 0) {
...
//     ASSERT_EQ(meanSquaredErrorJ.at("loss_data_type").get<DataType>(), lossDataType);
//
...
//     }
//
//     ASSERT_EQ(stampedMeanSquaredError->getPredictionsInput().value(), stampedFC->getFeatureOutputs()[0].value());
//     ASSERT_EQ(stampedMeanSquaredError->getLabelsInput().value(), stampedLabelsInput->getFeatureOutput().value());
//     if (stampedLossShaper) {
//         ASSERT_EQ(stampedMeanSquaredError->getLossOutput().value(), stampedLossShaper->getFeatureInput().value());
//         ASSERT_EQ(stampedLossShaper->getFeatureOutput().value(), stampedLossOutput->getFeatureInput().value());
//     } else if (stampedReshape) {
//         ASSERT_EQ(stampedMeanSquaredError->getLossOutput().value(), stampedReshape->getFeatureInput().value());
//         ASSERT_EQ(stampedReshape->getFeatureOutput().value(), stampedLossOutput->getFeatureInput().value());
//     } else {
//         ASSERT_EQ(stampedMeanSquaredError->getLossOutput().value(), stampedLossOutput->getFeatureInput().value());
//     }
//
