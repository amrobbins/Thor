...
//    { double meanAbsoluteError = 0.0; for (uint32_t row = 0; row < rows; ++row) {
...
//    fullyConnectedLayer = make_shared<FullyConnected>(numOutputFeatures, hasBias); layers.push_back(fullyConnectedLayer);
