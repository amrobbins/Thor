...
// FIXME: This test and MeanSquaredErrorTest both need to be expanded to cover all data tyeps. Do this before duplicating pattern further.

TEST(MeanAbsoluteError, ComputesCorrectResult_BatchLoss) {
    srand(time(NULL));
