...
//             ConvolutionTestHelper::computeOutputDimensionSize(numInputColumns, leftAndRightPadWidth, filterWidth,
...
//                         printf(
//                             "accumulate %d inputImageHeight %d inputImageWidth %d outputImageHeight %d outputImageWidth %d filterHeight
//                             %d " "filterWidth %d verticalStride %d horizontalStride %d verticalPadding %d horizontalPadding %d numWeights
//                             %d " "numInputChannels %d numOutputChannels %d batchSize %d\n", accumulate, inputImageHeight,
//                             inputImageWidth,
//                             outputImageHeight,
//                             outputImageWidth,
//                             filterHeight,
