...
class PhysicalRaggedTensor:
    ...
    def shares_partition_with(self, other: PhysicalRaggedTensor) -> bool: ...
...
class Expression:
    ...
    @staticmethod
    def conv2d(x: Expression, w: Expression, stride_h: int = 1, stride_w: int = 1, padding: object = (0, 0, 0, 0), output_dtype: object | None = None, compute_dtype: object | None = None, dilation_h: int = 1, dilation_w: int = 1) -> Expression: ...

    @staticmethod
    def conv3d(x: Expression, w: Expression, stride_d: int = 1, stride_h: int = 1, stride_w: int = 1, pad_d: int = 0, pad_h: int = 0, pad_w: int = 0, output_dtype: object | None = None, compute_dtype: object | None = None, groups: int = 1) -> Expression: ...
