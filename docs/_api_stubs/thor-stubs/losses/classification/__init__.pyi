...
class CategoricalFocalLoss(thor.losses.Loss):
    ...
    def __init__(self, network: thor.Network, predictions: object, labels: object, gamma: float = 2.0, alpha: float = 1.0, loss_data_type: thor.DataType | None = None, reported_loss_shape: thor.losses.LossShape | None = thor.losses.LossShape.batch, *, loss_weight: float | None = None) -> None:
        """
        Construct a dense or rank-1 ragged categorical focal loss from logits and dense targets.
        """
