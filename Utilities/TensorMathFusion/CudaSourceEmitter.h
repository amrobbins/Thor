...
class CudaSourceEmitter {
   public:
    static std::string emitFlat(const PhysicalExpression& expr, const std::string& kernel_name);
    static std::string emitFlat(const PhysicalExecutionStage& stage, const std::string& kernel_name);
