...
__global__ void elementWiseBinaryCrossEntropyLoss_oneHotSpecialCase(uint32_t numClasses,
                                                                    uint32_t batchSize,
...
__global__ void elementWiseBinaryCrossEntropyLoss_withScale(uint32_t numClasses,
                                                            uint32_t batchSize,
                                                            void *labels,
                                                            void *probabilities,
                                                            void *loss,
...
template <typename INDEX_TYPE, typename PROBABILITY_TYPE, typename LOSS_TYPE>
__global__ void elementWiseBinaryCrossEntropyLoss_oneHotSpecialCase_withScale(uint32_t numClasses,
                                                                              uint32_t batchSize,
                                                                              void *classOfHotLabels,
                                                                              void *probabilities,
                                                                              void *loss,
...
void launchElementWiseBinaryCrossEntropyLoss(void *labels_d,
    ...
    if (lossScalingFactor == 1) {
        elementWiseBinaryCrossEntropyLoss<LABEL_TYPE, PROBABILITY_TYPE, LOSS_TYPE><<<gridSize, blockSize, 0, stream.getStream()>>>(
...
void launchElementWiseBinaryCrossEntropyLoss_oneHotSpecialCase(void *classOfHotLabels_d,
    ...
    if (lossScalingFactor == 1) {
        elementWiseBinaryCrossEntropyLoss_oneHotSpecialCase<INDEX_TYPE, PROBABILITY_TYPE, LOSS_TYPE>
            <<<gridSize, blockSize, 0, stream.getStream()>>>(
                numClasses, batchSize, classOfHotLabels_d, probabilities_d, loss_d, gradient_d, computeGradient);
    } else {
        elementWiseBinaryCrossEntropyLoss_oneHotSpecialCase_withScale<INDEX_TYPE, PROBABILITY_TYPE, LOSS_TYPE>
            <<<gridSize, blockSize, 0, stream.getStream()>>>(
...
template void launchElementWiseBinaryCrossEntropyLoss_oneHotSpecialCase<uint8_t, half, half>(void *labels_d,
                                                                                             void *probabilities_d,
                                                                                             void *loss_d,
                                                                                             void *gradient_d,
                                                                                             uint32_t numClasses,
...
template void launchElementWiseBinaryCrossEntropyLoss_oneHotSpecialCase<uint8_t, half, float>(void *labels_d,
                                                                                              void *probabilities_d,
                                                                                              void *loss_d,
                                                                                              void *gradient_d,
                                                                                              uint32_t numClasses,
...
template void launchElementWiseBinaryCrossEntropyLoss_oneHotSpecialCase<uint8_t, float, half>(void *labels_d,
                                                                                              void *probabilities_d,
                                                                                              void *loss_d,
                                                                                              void *gradient_d,
                                                                                              uint32_t numClasses,
...
template void launchElementWiseBinaryCrossEntropyLoss_oneHotSpecialCase<uint8_t, float, float>(void *labels_d,
                                                                                               void *probabilities_d,
                                                                                               void *loss_d,
                                                                                               void *gradient_d,
                                                                                               uint32_t numClasses,
...
template void launchElementWiseBinaryCrossEntropyLoss_oneHotSpecialCase<uint16_t, half, half>(void *labels_d,
                                                                                              void *probabilities_d,
                                                                                              void *loss_d,
                                                                                              void *gradient_d,
                                                                                              uint32_t numClasses,
...
template void launchElementWiseBinaryCrossEntropyLoss_oneHotSpecialCase<uint16_t, half, float>(void *labels_d,
                                                                                               void *probabilities_d,
                                                                                               void *loss_d,
                                                                                               void *gradient_d,
                                                                                               uint32_t numClasses,
...
template void launchElementWiseBinaryCrossEntropyLoss_oneHotSpecialCase<uint16_t, float, half>(void *labels_d,
                                                                                               void *probabilities_d,
                                                                                               void *loss_d,
                                                                                               void *gradient_d,
                                                                                               uint32_t numClasses,
...
template void launchElementWiseBinaryCrossEntropyLoss_oneHotSpecialCase<uint16_t, float, float>(void *labels_d,
                                                                                                void *probabilities_d,
                                                                                                void *loss_d,
                                                                                                void *gradient_d,
                                                                                                uint32_t numClasses,
...
template void launchElementWiseBinaryCrossEntropyLoss_oneHotSpecialCase<uint32_t, half, half>(void *labels_d,
                                                                                              void *probabilities_d,
                                                                                              void *loss_d,
                                                                                              void *gradient_d,
                                                                                              uint32_t numClasses,
...
template void launchElementWiseBinaryCrossEntropyLoss_oneHotSpecialCase<uint32_t, half, float>(void *labels_d,
                                                                                               void *probabilities_d,
                                                                                               void *loss_d,
                                                                                               void *gradient_d,
                                                                                               uint32_t numClasses,
...
template void launchElementWiseBinaryCrossEntropyLoss_oneHotSpecialCase<uint32_t, float, half>(void *labels_d,
                                                                                               void *probabilities_d,
                                                                                               void *loss_d,
                                                                                               void *gradient_d,
                                                                                               uint32_t numClasses,
...
template void launchElementWiseBinaryCrossEntropyLoss_oneHotSpecialCase<uint32_t, float, float>(void *labels_d,
                                                                                                void *probabilities_d,
                                                                                                void *loss_d,
                                                                                                void *gradient_d,
                                                                                                uint32_t numClasses,
