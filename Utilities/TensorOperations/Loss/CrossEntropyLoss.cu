 ...
 *
 * The general case allows soft labels. Say you had an aquatic car capable of driving on a lake,
 * you could then say it's label is 0.5 for the car class and 0.5 for the boat class.
 *
