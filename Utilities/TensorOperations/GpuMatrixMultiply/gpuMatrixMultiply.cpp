...
//                                   stream);
//     if (kernelInfo.CElementOrder == ElementOrder::CPP_ROW_MAJOR) {
//         if (kernelInfo.dataType == ThorImplementation::DataType::FP32) {
...
//     cudaDataType_t precision = dataType == ThorImplementation::DataType::FP32 ? CUDA_R_32F : CUDA_R_16F;
//     cublasComputeType_t computeType = dataType == ThorImplementation::DataType::FP32 ? CUBLAS_COMPUTE_32F : CUBLAS_COMPUTE_16F;
