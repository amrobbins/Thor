...
#include "Utilities/TensorOperations/Arithmetic/Exponential.h"
...
class Exponential : public Activation {
   public:
    ...
    virtual void infer(Optional<Tensor> inputTensor, Optional<Tensor> outputTensor, Stream stream) {
        ...
        launchExponential((half*)outputTensor.get().getMemPtr(),
    ...
    virtual void backProp(Optional<Tensor> dataIn, Optional<Tensor> errorIn, Optional<Tensor> errorOut, Stream stream) {
        ...
        assert(placement.getMemDevice() == TensorPlacement::MemDevices::GPU);
        launchExponentialBackward((half*)errorOut.get().getMemPtr(),
