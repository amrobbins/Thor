...
//     Expression expr, const string& inputName, vector<shared_ptr<Parameter>> parameters, int deviceNum, bool useFastMath, int64_t
//     stampedId) : TrainableWeightsBiasesLayer(false, stampedId),
//       expr(std::move(expr)),
//       inputName(inputName),
//       deviceNum(deviceNum),
