...
class RMSNorm : public TrainableLayer {
   public:
    ...
    RMSNorm(const TensorPlacement& placement,
            bool inferenceOnly,
    ...
    std::string getLayerType() override { return "RMSNorm"; }
    ...
    CudnnRmsNormFusedActivation getFusedActivation() const { return fusedActivation; }
