...
class InfoNCELoss : public Loss {
   public:
    class Builder;
    InfoNCELoss() {}

    ~InfoNCELoss() override {}

    std::shared_ptr<Layer> clone() const override { return std::make_shared<InfoNCELoss>(*this); }

    std::string getLayerType() const override { return "InfoNCELoss"; }
   ...
   protected:
    ...
    std::shared_ptr<ThorImplementation::Layer> stamp(ThorImplementation::TensorPlacement placement,
        ...
        (void)inferenceOnly;
        throw std::runtime_error("InfoNCELoss is a compound API loss and should not be stamped directly.");
    }
...
class InfoNCELoss::Builder {
   public:
    virtual ~Builder() = default;

    virtual InfoNCELoss build() {
    ...
    virtual InfoNCELoss::Builder &network(Network &_network) {
        THOR_THROW_IF_FALSE(!this->_network.has_value());
        this->_network = &_network;
        return *this;
    }

    virtual InfoNCELoss::Builder &predictions(Tensor _predictions) {
    ...
    virtual InfoNCELoss::Builder &labels(Tensor _labels) {
    ...
    virtual InfoNCELoss::Builder &temperature(float _temperature) {
    ...
    virtual InfoNCELoss::Builder &reportsBatchLoss() {
        THOR_THROW_IF_FALSE(!this->_lossShape.has_value());
        _lossShape = LossShape::BATCH;
        return *this;
    }

    virtual InfoNCELoss::Builder &reportsPerExampleLoss() {
        THOR_THROW_IF_FALSE(!this->_lossShape.has_value());
        _lossShape = LossShape::PER_EXAMPLE;
        return *this;
    }

    virtual InfoNCELoss::Builder &reportsPerOutputLoss() {
        THOR_THROW_IF_FALSE(!this->_lossShape.has_value());
        _lossShape = LossShape::PER_OUTPUT;
        return *this;
    }

    virtual InfoNCELoss::Builder &reportsNoLoss() {
        THOR_THROW_IF_FALSE(!this->_lossShape.has_value());
        _lossShape = LossShape::NONE;
        return *this;
    }

    virtual InfoNCELoss::Builder &reportsRawLoss() {
        THOR_THROW_IF_FALSE(!this->_lossShape.has_value());
