...
json NetworkInput::architectureJson() const {
    return json{{"factory", Layer::Factory::Layer.value()},
                ...
                {"alias_same_placement_inputs", aliasSamePlacementInputs()},
...
void NetworkInput::deserialize(const json &j, Network *network) {
    ...
    bool aliasSamePlacementInputs = j.value("alias_same_placement_inputs", false);
    ...
    networkInput.aliasSamePlacementInputs_ = aliasSamePlacementInputs;
