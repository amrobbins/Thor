...
class HardSigmoid : public Activation {
   public:
    ...
    virtual shared_ptr<Layer> clone() const { return make_shared<HardSigmoid>(*this); }

    virtual string getLayerType() const { return "HardSigmoid"; }
...
class HardSigmoid::Builder : public Activation::Builder {
   public:
    ...
    virtual shared_ptr<Activation::Builder> clone() { return make_shared<HardSigmoid::Builder>(*this); }
