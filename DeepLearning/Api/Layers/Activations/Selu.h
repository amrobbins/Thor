...
class Selu : public Activation {
   public:
    ...
    virtual shared_ptr<Layer> clone() const { return make_shared<Selu>(*this); }

    virtual string getLayerType() const { return "Selu"; }
...
class Selu::Builder : public Activation::Builder {
   public:
    ...
    virtual shared_ptr<Activation::Builder> clone() { return make_shared<Selu::Builder>(*this); }
