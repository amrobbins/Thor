...
// Compatibility aliases retained while downstream code migrates from the
// historical Loader terminology to the per-run BatchSession API.
using DeviceResidentNamedBatchLoader = DeviceResidentNamedBatchSession;
using DeviceResidentNamedBatchLoaderStats = DeviceResidentNamedBatchSessionStats;
