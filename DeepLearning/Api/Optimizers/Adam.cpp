...
//         shared_ptr<ThorImplementation::Adam> sisterPhysicalAdam =
//         dynamic_pointer_cast<ThorImplementation::Adam>(sisterPhysicalOptimizer); assert(sisterPhysicalAdam != nullptr);
