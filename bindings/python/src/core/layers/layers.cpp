...
void bind_layers(nb::module_ &layers) {
    ...
    bind_segmented_broadcast(layers);
    bind_segmented_log_softmax(layers);
    bind_segmented_reduction(layers);
    bind_segmented_softmax(layers);
    bind_slice(layers);
    ...
    bind_ragged_sequence_concatenate(layers);
    bind_ragged_sequence_slice(layers);
    bind_network_output(layers);
    bind_ragged_network_output(layers);
    bind_pooling(layers);
    bind_padded_dense_to_ragged(layers);
    bind_reshape(layers);
    bind_stub(layers);
