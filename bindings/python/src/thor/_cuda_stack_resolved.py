...
CUDA_STACK = CudaStack(
    ...
    distributions=(
        ...
        CudaDistribution("nvidia-cublas", "13.5.1.27"),
        CudaDistribution("nvidia-cusparse", "12.8.1.7"),
        CudaDistribution("nvidia-cusolver", "12.2.2.18"),
        CudaDistribution("nvidia-cuda-cccl", "13.3.3.3.1"),
        CudaDistribution("nvidia-cudnn-cu13", "9.23.2.1"),
